        ...
        <section className="bg-[#1A1F2C] text-white py-16">
          <div className="container mx-auto px-4">
            ...
            <Button asChild className="inline-flex items-center bg-[#ea384c] hover:bg-[#ea384c]/90 text-white">
              <a href="https://alwjzubhrjubtvwenyqt.supabase.co/storage/v1/object/public/alemaraprojectimages/Alemara%20Portfolio.pdf" target="_blank" rel="noopener noreferrer">
