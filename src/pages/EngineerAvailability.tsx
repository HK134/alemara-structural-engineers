...
import { format, startOfWeek, addDays, addHours, startOfDay, isAfter, isBefore } from 'date-fns';
...
const EngineerAvailability = () => {
  ...
  const generateWeekView = () => {
    ...
    const days = Array.from({ length: 5 }, (_, i) => addDays(weekStart, i)); // Monday to Friday
          ...
          <TabsContent value="weekly" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Overview of your available time slots for the week
                </CardDescription>
              </CardHeader>
              <CardContent>
                {generateWeekView()}
