  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <link rel="canonical" href="https://londonstructuralsurveys.com/portfolio-alternative" />
      </Helmet>
      ...
      <main className="flex-grow">
        ...
        <section className="bg-[#1A1F2C] text-white py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8">
              <Link to="/portfolio" className="text-white hover:text-[#ea384c] underline transition-colors">
