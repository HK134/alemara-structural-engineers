...
import { Award, Clock, MapPin, ThumbsUp, GraduationCap, FileText, History, Building, CheckCircle } from 'lucide-react';
...
const reasons = [
  ...
  {
    icon: <Building className="h-12 w-12 text-[#ea384c]" />,
    title: "Trusted by Local Councils",
    description: "We have established strong relationships with all London borough councils and maintain a 100% approval rate with building control authorities."
  },
  {
    icon: <FileText className="h-12 w-12 text-[#ea384c]" />,
    title: "Jargon-Free Engineering",
    description: "We explain our designs and findings in clear, straightforward language, ensuring you fully understand every aspect of your project."
  }
];
